      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            {/* ✅ REAL DATA - Märke/Modell från Car.info API */}
            ...
            {/* ✅ REAL DATA - Modellår från Car.info API */}
            <div className="flex items-center">
              <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* MOCK DATA - Mätarställning inte tillgänglig i demo API */}
            <div className="flex items-center">
              <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* ✅ REAL DATA - Hästkrafter från Car.info API */}
            <div className="flex items-center">
              <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            ...
            {/* MOCK DATA - Antal ägare inte tillgänglig i demo API */}
            <div className="flex items-center">
              <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
