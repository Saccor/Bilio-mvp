...
export default function SellerInformation({ isComparison = false }: SellerInformationProps) {
  /** MOCK DATA - Säljaresinformation är simulerad */
  const DealerCard = () => (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 flex flex-col h-full">
